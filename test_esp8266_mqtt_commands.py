...
# Configurações
MQTT_BROKER_HOST = "192.168.3.129"
MQTT_BROKER_PORT = 1883
DEFAULT_DEVICE_ID = "temp_sensor_esp_001"

class ESP8266MQTTTester:
    def __init__(self, device_id):
        self.device_id = device_id
        self.command_topic = f"smart_city/commands/sensors/{device_id}"
        self.response_topic = f"smart_city/commands/sensors/{device_id}/response"
        self.data_topic = f"smart_city/sensors/{device_id}"
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            logger.error(f"Erro ao decodificar JSON de {topic}: {payload}")
